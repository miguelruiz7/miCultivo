...
<div class="modal top fade" id="agregar" tabindex="-1" aria-labelledby="agregar" aria-hidden="true" data-bs-backdrop="true" data-bs-keyboard="true">
    ...
    <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
                    ...
                    <div class="form-floating mb-3">
                      <input type="date"  title="Se entiende por finalización de cultivo, a partir de la cosecha del cultivo" name="txtff" class="form-control rounded-3" id="floatingInput">
    ...
    <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
                      ...
                      <div class="col">
                        <div class="form-floating mb-3">
                      <input type="text" name="txtarea" class="form-control rounded-3" id="floatingInput">
                      ...
                      <div class="col">
                    <div class="form-floating mb-3">
                      <input type="text" name="txtreni" class="form-control rounded-3" id="floatingInput">

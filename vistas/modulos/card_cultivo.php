...
<button type="button" class="btn btn-sm btn-outline-light" data-bs-toggle="modal" data-bs-target="#planificar<?php echo $datos["id"]; ?>"><?php echo $i_externo; ?> Planificar</button>
...
<!-- <button type="button" class="btn btn-sm btn-outline-light" data-bs-toggle="modal" data-bs-target=""> Resultados</button> -->

...
<!-- Cuerpo -->
                  <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-1">
                    <div class="col-md-8">
                    <h4 class="fw-light">Datos:</h3>
                    <div class="form-floating mb-3">
                    <select name="tipocultivo" class="form-control rounded-3" id="floatingInput">
                            <option value="0" selected="">Seleccione:</option> 
                    </select>
                    <label for="floatingInput">Tipo de calculo</label>
                    </div>
                    </div>
                    
                    <div class="col">
                    <h4 class="fw-light">Resultado:</h3>
                      <div class="form-floating mb-3">
                    <input type="date" title="Se entiende por fecha de inicio, a partir de la siembra del cultivo" name="ffinal" class="form-control rounded-3" id="floatingInput">
  ...
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>
                  ...
                  <div class="form-floating mb-3">
                    <input type="date"  title="Se entiende por finalización de cultivo, a partir de la cosecha del cultivo" name="finicio" class="form-control rounded-3" id="floatingInput">
